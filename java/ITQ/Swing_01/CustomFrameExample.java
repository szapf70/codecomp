...
public class CustomFrameExample {
    ...
    public static void main(String[] args) {
        ...
        frame.setUndecorated(true); // Entfernt die Standard-Titelleiste
        frame.setResizable(false); // Macht das JFrame nicht resizable

        // Erstelle eine neue Titelleiste
        JPanel titlePanel = new JPanel(new BorderLayout());
        JLabel titleLabel = new JLabel("Erweiterter Taschenrechner", JLabel.CENTER);
        
        // Füge einen Schließen-Knopf hinzu
        ...
        // Füge Maus-Listener hinzu, um das Fenster verschiebbar zu machen
        ...
        titlePanel.addMouseMotionListener(new MouseMotionAdapter() {
            public void mouseDragged(MouseEvent e) {
                // Holen Sie sich die aktuelle Position des Fensters
                int thisX = frame.getLocation().x;
                int thisY = frame.getLocation().y;

                // Bestimmen Sie, wie weit die Maus bewegt wurde
                int xMoved = e.getX() - initialClick.x;
                int yMoved = e.getY() - initialClick.y;

                // Berechnen Sie die neue Position des Fensters
                int X = thisX + xMoved;
                int Y = thisY + yMoved;
        ...
        // Füge die neue Titelleiste und das Panel dem Frame hinzu
